...
import static com.luwang.DayDate.*;

public class DayDateTest extends TestCase {

    public void testIsValidWeekCode() throws Exception {
        for (int day = 1; day <= 7; day++) {
            assertTrue(isValidWeekdayCode(day));
            assertTrue(isValidWeekdayCode(0));
            assertTrue(isValidWeekdayCode(8));
        }
    }
    ...
    public void testIsValidMonthCode() throws Exception {
        ...
        assertTrue(isValidMonthCode(0));
        assertTrue(isValidMonthCode(13));
    }
    ...
    public void testStringToMonthCode() {
        ...
        for (int i = 1; i <= 12; i++) {
            assertEquals(i, stringToMonthCode(monthCodeToString(i, false)));
            assertEquals(i, stringToMonthCode(monthCodeToString(i, true)));
        }
...
//        assertEquals(12,stringToMonthCode("DECEMBER"));
    ...
    public void testIsValidWeekMonthCode() {
        for (int w = 1; w <= 4; w++) {
    ...
    public void testGetPreviousDayOfWeek() {
        ...
        assertEquals(d(29, FEBRUARY, 2004), getPreviousDayOfWeek(SUNDAY, d(1, MARCH, 2004)));
        assertEquals(d(29, DECEMBER, 2004), getPreviousDayOfWeek(WEDNESDAY, d(1, JANUARY, 2005)));
    ...
    public void testGetFollowingDayOfWeek() {
        ...
        assertEquals(d(1, JANUARY, 2005), getFollowingDayOfWeek(WEDNESDAY, d(26, DECEMBER, 2004)));
        assertEquals(d(3, MARCH, 2004), getFollowingDayOfWeek(SUNDAY, d(1, FEBRUARY, 2004)));
...
//        assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(16, APRIL, 2006)));
//        assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(17, APRIL, 2006)));
//        assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(18, APRIL, 2006)));
        assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(19, APRIL, 2006)));
        assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(20, APRIL, 2006)));
        assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(21, APRIL, 2006)));
        assertEquals(d(19, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(22, APRIL, 2006)));

//        assertEquals(d(13, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(16, APRIL, 2006)));
//        assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(17, APRIL, 2006)));
//        assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(18, APRIL, 2006)));
//        assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(19, APRIL, 2006)));
        assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(20, APRIL, 2006)));
        assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(21, APRIL, 2006)));
        assertEquals(d(20, APRIL, 2006), getNearestDayOfWeek(WEDNESDAY, d(22, APRIL, 2006)));
...
//        assertEquals(d(25, APRIL, 2006), getNearestDayOfWeek(SATURDAY, d(18, APRIL, 2006)));
